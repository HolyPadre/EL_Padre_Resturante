...
public class RegisterChefActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usernameET = (EditText) findViewById(R.id.username_chef);
        passwordET = (EditText) findViewById(R.id.password_chef);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.profile:
                Intent intent1 = new Intent(RegisterChefActivity.this, ManegerActivity.class);
                startActivity(intent1);
                break;
            case R.id.add_delivery:
                Intent intent = new Intent(RegisterChefActivity.this, RegisterDeliveryActivity.class);
            ...
            case R.id.logout:
                ...
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(RegisterChefActivity.this);
                SharedPreferences.Editor editor = prefs.edit();

                editor.remove("userprofile");
                editor.apply();

                Intent intent3 = new Intent(RegisterChefActivity.this, LoginActivity.class);
    ...
    public void performRegisterChef(View view) {
        String username = usernameET.getText().toString().trim();
        String password = passwordET.getText().toString();

        if(isValidUsername(username) && isValidPassword(password)) {
            String query = "insert into user (username, password, type) values ('" + username + "'," + "'" + password + "',2);";
            String url = BASE_URL + "?query=" + query;

            RequestQueue queue = Volley.newRequestQueue(RegisterChefActivity.this);
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    if(response.contains("Duplicate")) {
                        ...
                        Toast.makeText(RegisterChefActivity.this, "Add Chef successful", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(RegisterChefActivity.this, ManegerActivity.class);
                        startActivity(intent);
                    }
                }
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(RegisterChefActivity.this, "Fail to register data..", Toast.LENGTH_SHORT).show();
                }
            });
